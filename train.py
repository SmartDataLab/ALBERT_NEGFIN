...
class Instructor:
    ...
    def _print_args(self): #打应所需要训练的模型参数
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', default=32, type=int)  #服务器上运行时可调的参数
    parser.add_argument('--log_step', default=30, type=int)
    parser.add_argument('--embed_dim', default=300, type=int)  #ALBERT参数
    parser.add_argument('--hidden_dim', default=300, type=int)  #ALBERT参数
    parser.add_argument('--polarities_dim', default=3, type=int)    #ALBERT参数
    parser.add_argument('--save', default=False, type=bool)
    parser.add_argument('--seed', default=776, type=int)
    parser.add_argument('--device', default=None, type=str)      #设置GPU，也可以用pytorch的并行组件写一个multi_run
    opt = parser.parse_args()

    model_classes = {
        'bert': BERT_SPC,    #这里引入albert的pytorch版本
        # 'albert': albert_pytorch_model,
    }
    input_colses = {
